...
\node (tree3_expandednode) [below right=0.5cm and 0.3cm of tree3_node5]{\Large $\pmb f_\theta$};
...
\node (params) [below=3.2cm of root_3]{\Large $f_\theta (\mathbf s) = \big( \pmb \mu, \, \pmb \sigma, \hat V \big)$};
